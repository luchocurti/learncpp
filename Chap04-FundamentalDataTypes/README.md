...
+ 4.01 - Introduction to fundamental data types
+ 4.02 - Void
+ 4.03 - Object sizes and the sizeof operator
+ 4.04 - Signed integers
+ 4.05 - Unsigned integers, and why to avoid them
+ 4.06 - Fixed-width integers and size_t
+ 4.07 - Introduction to scientific notation
+ 4.08 - Floating point numbers
+ 4.09 - Boolean values
+ 4.10 - Introduction to if statements
+ 4.11 - Chars
+ 4.12 - Introduction to type conversion and static_cast
+ 4.13 - Chapter 4 summary and quiz
