...
+ 8.01 - Control flow introduction
+ 8.02 - If statements and blocks
+ 8.03 - Common if statement problems
+ 8.04 - Constexpr if statements
+ 8.05 - Switch statement basics
+ 8.06 - Switch fallthrough and scoping
+ 8.07 - Goto statements
+ 8.08 - Introduction to loops and while statements
+ 8.09 - Do while statements
+ 8.10 - For statements
...
+ 8.16 - Chapter 8 summary and quiz
