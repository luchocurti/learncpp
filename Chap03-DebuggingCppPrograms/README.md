...
+ 3.01 - Syntax and semantic errors
+ 3.02 - The debugging process
+ 3.03 - A strategy for debugging
+ 3.04 - Basic debugging tactics
+ 3.05 - More debugging tactics
+ 3.06 - Using an integrated debugger: Stepping
+ 3.07 - Using an integrated debugger: Running and breakpoints
+ 3.08 - Using an integrated debugger: Watching variables
+ 3.09 - Using an integrated debugger: The call stack
+ 3.10 - Finding issues before they become problems
+ 3.11 - Chapter 3 summary and quiz
