...
+ 7.01 - Compound statements (blocks)
+ 7.02 - User-defined namespaces and the scope resolution operator
+ 7.03 - Local variables
+ 7.04 - Introduction to global variables
+ 7.05 - Variable shadowing (name hiding)
+ 7.06 - Internal linkage
+ 7.07 - External linkage and variable forward declarations
+ 7.08 - Why (non-const) global variables are evil
+ 7.09 - Inline functions and variables
...
+ 7.15 - Chapter 7 summary and quiz
